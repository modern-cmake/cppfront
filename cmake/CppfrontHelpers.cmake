...
function(cppfront_enable)
    ...
    foreach (tgt IN LISTS ARG_TARGETS)
        ...
        if (sources)
            get_target_property(linktype "${tgt}" TYPE)
            if (${linktype} STREQUAL "INTERFACE_LIBRARY")
                target_link_libraries("${tgt}" INTERFACE cppfront::cpp2util)
            else ()
            ...
            if (${linktype} STREQUAL "INTERFACE_LIBRARY")
                target_sources("${tgt}" INTERFACE ${cpp1sources})
            else ()
